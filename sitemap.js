         ...
         // get the post labels from the entry
            ...
            if ("category" in entry) {
               for (var k = 0; k < entry.category.length; k++) {
                  pll += '<a href="javascript:filterPosts(\'' + entry.category[k].term + '\');" title="Klik untuk melihat artikel \'' + entry.category[k].term + '\'">' + entry.category[k].term + '</a>,  ';
               }
...
// this function creates a three-column table and adds it to the screen
   ...
   var tocTable = '';
   var tocHead1 = 'JUDUL';
   var tocTool1 = 'Sortir berdasar judul';
   var tocHead2 = 'TANGGAL';
   var tocTool2 = 'Sortir berdasar tanggal';
   var tocHead3 = 'LABEL';
   var tocTool3 = '';
   if (sortBy == "titleasc") { 
      tocTool1 += ' (descending)';
...
function hideToc() {
  ...
  tocdiv.innerHTML = '';
  var toclink = document.getElementById("toclink");
  toclink.innerHTML = '<a href="#" onclick="scroll(0,0); showToc(); Effect.toggle('+"'toc-result','blind');"+'">» Tampilkan tabel</a> <img src="http://chenkaie.blog.googlepages.com/new_1.gif"/>';
}
